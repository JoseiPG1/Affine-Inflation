...
\begin{equation}
  \dddot{a}+ 5\frac{\ddot{u}\dot{a}}{a} = 0
\end{equation}
Notice that the complexity of the differential equations system is reduced entirely by imposing the equality of the factors.
