...
From eq. \Ref{harmonic_feq} we can distinguis three families of solutions along with the scalar field equation:

\begin{center}
  \textit{Reduced field equation}
\end{center}
\begin{equation}
...
\begin{center}
  \textit{Paralell field equation}
\end{center}
\begin{equation}
  \nabla_\gamma \left(\frac{\mathcal{R}_{\mu\nu} - C\partial_\mu \phi \partial_\nu \phi}{\mathcal{V}(\phi)}\right) = \nabla_\gamma \left(\Lambda g_{\mu\nu}\right)
\end{equation}

\begin{center}
  \textit{Harmonic field equation}
\end{center}
\begin{equation}
  \nabla_{[\mu}\left(\mathcal{R}_{\nu]\gamma}\frac{1}{\mathcal{V}(\phi)}\right) 
...
\begin{equation}
  \ddot{\phi}(t) + 3a(t)\dot{a}(t)\dot{\phi}(t) - \Lambda \mathcal{V}'(\phi) = 0
\end{equation}
