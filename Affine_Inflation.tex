...
where $\mathcal{V}'(\phi) = \frac{\partial \mathcal{V}(\phi)}{\partial \phi}$. The above equation is the scalar field equation.
...
\begin{equation}
  g_{\mu\nu} = \mathcal{F}(t)\mathrm{d}t^2 + \mathcal{G}(t)\left(\frac{1}{1 - \kappa r^2} \mathrm{d}r^2 + r^2 \mathrm{d}\theta^2 
...
\begin{align}
  \mathcal{F}(t) & = F_0 & h(t) & = \frac{\dot{\mathcal{G}(t)}}{\mathcal{G}(t)} & g(t) & = \dot{\mathcal{G}(t)}\mathcal{G}(t)
\end{align}
